...
_ax.plot(plot_axis(sample(lambda X_s: matcol(Contour, 0), X_s), ureg.mm), plot_axis(sample(lambda X_s: matcol(Contour, 1), X_s), ureg.mm), label='matcol(Contour, 0)', color='#00008B')
_ax.plot(plot_axis(sample(lambda X_s: matcol(stirrup, 0), X_s), ureg.mm), plot_axis(sample(lambda X_s: matcol(stirrup, 1), X_s), ureg.mm), label='matcol(stirrup, 0)', color='#932329')
_ax.plot(plot_axis(X_s, ureg.mm), plot_axis(sample(lambda X_s: Y_s, X_s), ureg.mm), label='Y_s', color='#932329')
_ax.plot(plot_axis(sample(lambda X_s: X_c, X_s), ureg.mm), plot_axis(sample(lambda X_s: Y_c, X_s), ureg.mm), label='X_c', color='#A1A3A6')
...
_ax.plot(plot_axis(sample(lambda X_s: matcol(Contour, 0), X_s), ureg.mm), plot_axis(sample(lambda X_s: matcol(Contour, 1), X_s), ureg.mm), label='matcol(Contour, 0)', color='#00008B')
_ax.plot(plot_axis(X_s, ureg.mm), plot_axis(sample(lambda X_s: Y_s, X_s), ureg.mm), label='Y_s', color='#932329')
_ax.plot(plot_axis(sample(lambda X_s: matcol(NA, 0), X_s), ureg.mm), plot_axis(sample(lambda X_s: matcol(NA, 1), X_s), ureg.mm), label='matcol(NA, 0)', color='#068149')
_ax.plot(plot_axis(sample(lambda X_s: matcol(CGi, 0), X_s), ureg.mm), plot_axis(sample(lambda X_s: matcol(CGi, 1), X_s), ureg.mm), label='matcol(CGi, 0)', color='#662D91')
_ax.axhline(0, color='0.6', linewidth=0.8)
_ax.axvline(0, color='0.6', linewidth=0.8)
_ax.grid(True, alpha=0.3)
_ax.set_xlabel('(mm)')
